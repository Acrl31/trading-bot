...
def execute_trade(instrument):
    try:
        ...
        stop_loss = current_price - atr * 0.125 if prediction == 1 else current_price + atr * 0.125
        take_profit = current_price + atr * 0.25 if prediction == 1 else current_price - atr * 0.25
