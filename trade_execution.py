...
def get_latest_data(instrument):
    try:
        params = {"granularity": "S5", "count": 100, "price": "M"}
...
def execute_trade(instrument):
    try:
        ...
        stop_loss = current_price - atr * 0.75 if prediction == 1 else current_price + atr * 0.75
        take_profit = current_price + atr * 0.15 if prediction == 1 else current_price - atr * 0.15
